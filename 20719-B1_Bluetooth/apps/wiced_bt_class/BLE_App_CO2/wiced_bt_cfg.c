...
uint8_t BT_LOCAL_NAME[] = { 'B','L','E','_','A','p','p','_','C','O','2','\0' };
...
const wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
{
    ...
    .ble_scan_cfg = {
        ...
        .high_duty_conn_duration =          0,                                                         /**< High Duty Connection Cycle Connection Duration in seconds (0 for infinite) */
        ...
        .low_duty_conn_duration =           0,                                                         /**< Low Duty Connection Cycle Connection Duration in seconds (0 for infinite) */
...
/*  { buf_size, buf_count, }, */
    ...
    { 2048,     2,         }, /* Extra Large Buffer Pool (used for AVDT media packets, GATT DB, and miscellaneous; if not needed, set buf_count to 0) */
};
